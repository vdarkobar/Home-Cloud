...
<p align="center">
Clone <a href="https://github.com/vdarkobar/Home-Cloud/blob/main/README.md#debian-server-template">Debian server template</a>, copy and run commands on the server to install services:
</p>
<br><br>
